...
const StructuralPointsListItem = (props: StructuralPointsListItemProps) => {
...
const StructuralPointsList = (props: StructuralPointsListProps) => {
    return (
        <>
...
const Structure = (props: StructureProps) => {
    ...
    const onNewPoint = () => {
        history.push("/structuralpoint/" + props.projectId);
    }
    ...
    return (
        <>
            <Header onBack={onBack} disabledBackButton={false} title={""} />
            <Container fluid>
                <Row>
