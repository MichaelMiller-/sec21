   ...
   NLOHMANN_JSON_SERIALIZE_ENUM(ForceAppearance, {
	...
	void to_json(nlohmann::json &j, preferences const &e)
	{
		j = nlohmann::json{
			...
			{"show_nodes", e.show_nodes}, 
			{"show_members", e.show_members},
			{"show_supports", e.show_supports},
			{"show_deformation", e.show_deformation},
			{"show_load", e.show_load},
			{"force_appearance", e.force_appearance},
			{"radius_node", e.radius_node},
			{"radius_member", e.radius_member},
			{"scale_load", e.scale_load},
			{"clear_color", e.clear_color}
		};
	}
