...
auto generate_output_string(
   mesh const& m,
   std::string mesh_name = "generated_mesh",
...
int main(int argc, const char** argv)
{
	try
	{
      ...
      desc.add_options()
         ...
         ("input-file", po::value<decltype(input_file)>(), "input filename")
         ("output-file,O", po::value<decltype(output_file)>(&output_file)->default_value(output_file), "name of the struct and output filename")
      ;
