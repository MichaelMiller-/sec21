...
namespace sec21::meta
{
   ...
   struct difference<List<>, List<Ts...>, Compare>
   {
      using type = List<>;
   };
   ...
   struct difference<List<First, Rest...>, List<Right...>, Compare>
   {
   private:
      using rest_t = difference<List<Rest...>, List<Right...>, Compare>::type;

   public:
      using type =
         std::conditional_t<not Compare<First, Right...>::value, typename push_front<First, rest_t>::type, rest_t>;
   };
} // namespace sec21::meta
