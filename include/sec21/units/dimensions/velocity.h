...
namespace sec21::units
{
   ...
   {
      constexpr auto operator""_mps(unsigned long long v) noexcept
      {
         return quantity<meter_per_second, unsigned long long>{v};
      }
      constexpr auto operator""_kmph(unsigned long long v) noexcept
      {
         return quantity<kilometer_per_hour, unsigned long long>{v};
      }
   } // namespace literals
} // namespace sec21::units
