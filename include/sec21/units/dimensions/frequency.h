...
namespace sec21::units
{
   ...
   inline namespace literals
   {
      ...
      constexpr auto operator""_kHz(unsigned long long v) noexcept
      {
         return quantity<kilohertz, unsigned long long>{v};
      }
      constexpr auto operator""_GHz(unsigned long long v) noexcept
      {
         return quantity<gigahertz, unsigned long long>{v};
      }
   } // namespace literals
} // namespace sec21::units
