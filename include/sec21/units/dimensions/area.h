...
namespace sec21::units
{
   ...
   struct square_millimeter : derived_unit<square_millimeter, area, std::milli> {};
   struct square_centimeter : derived_unit<square_centimeter, area, std::centi> {};
   struct square_kilometer : derived_unit<square_kilometer, area, std::kilo> {};
