...
namespace sec21::units
{
   ...
   {
      constexpr auto operator"" _sq_m(unsigned long long v) noexcept
      {
         return quantity<square_meter, unsigned long long>{v};
      }
      constexpr auto operator"" _sq_m(long double v) noexcept { return quantity<square_meter, long double>{v}; }

      constexpr auto operator"" _sq_mm(unsigned long long v) noexcept
      {
         return quantity<square_millimeter, unsigned long long>{v};
      }
      constexpr auto operator"" _sq_mm(long double v) noexcept { return quantity<square_millimeter, long double>{v}; }

      constexpr auto operator"" _sq_cm(unsigned long long v) noexcept
      {
         return quantity<square_centimeter, unsigned long long>{v};
      }
      constexpr auto operator"" _sq_cm(long double v) noexcept { return quantity<square_centimeter, long double>{v}; }

      constexpr auto operator"" _sq_km(unsigned long long v) noexcept
      {
         return quantity<square_kilometer, unsigned long long>{v};
      }
