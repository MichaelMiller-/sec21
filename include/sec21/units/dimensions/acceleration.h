...
namespace sec21::units
{
   ...
   {
      constexpr auto operator""_mps_sq(unsigned long long v) noexcept
      {
         return quantity<meter_per_second_squared, unsigned long long>{v};
      }
      constexpr auto operator""_mps_sq(long double v) noexcept
      {
         return quantity<meter_per_second_squared, long double>{v};
      }
   } // namespace literals
} // namespace sec21::units
